...
console.log(`Platform: ${resources.getPlatform()}`)
console.log(resources.colorQuantity())
console.log(resources.totalMemory())
resources.usedMemoryRatio()
console.log(`PID: ${resources.processId()}`)